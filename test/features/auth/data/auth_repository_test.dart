...
void main() {
  ...
  group('getMe', () {
    ...
    test('503 persistente → agota reintentos y lanza ApiException(503)', () async {
      when(() => dio.get<Map<String, dynamic>>('/auth/me')).thenAnswer(
        (_) async => throw dioErr(503, 'SERVICE_UNAVAILABLE', 'Supabase caído'),
      );
    ...
    test('401 NO se reintenta: lanza ApiException(401) en el 1º intento', () async {
      when(() => dio.get<Map<String, dynamic>>('/auth/me')).thenAnswer(
  ...
  group('changePassword', () {
    ...
    test('400 → ApiException con el message del servidor', () async {
      when(
        ...
        (_) async => throw dioErr(400, 'VALIDATION_ERROR', 'Contraseña muy débil'),
      );
